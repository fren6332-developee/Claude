...
fonts-shipped:
  note: >
    Real font files ARE present in this project at assets/fonts/ — declare @font-face
    pointing at them (do not fall back to system-ui/sans-serif for display or body text).
  Fredoka:
    file: "assets/fonts/Fredoka-VariableWeight.woff2"
    format: "woff2-variations supported (variable font); a plain 'woff2' format hint also works"
    weight-range: "500 700"
    usage: "@font-face { font-family: 'Fredoka'; src: url('assets/fonts/Fredoka-VariableWeight.woff2') format('woff2'); font-weight: 500 700; font-style: normal; } — then use font-family: 'Fredoka', sans-serif; font-weight: 600 (or 700 for heaviest headlines)"
  Quicksand:
    file: "assets/fonts/Quicksand-VariableWeight.woff2"
    format: "woff2-variations supported (variable font); a plain 'woff2' format hint also works"
    weight-range: "500 700"
    usage: "@font-face { font-family: 'Quicksand'; src: url('assets/fonts/Quicksand-VariableWeight.woff2') format('woff2'); font-weight: 500 700; font-style: normal; } — then use font-family: 'Quicksand', sans-serif; font-weight: 500/600 per role"
...
typography:
  ...
  badge:   { fontFamily: "Fredoka", weight: 600, cqw: 0.9, tracking: "0.02em" }
  label-display:{ fontFamily: "Fredoka", weight: 600, cqw: 1.3, lineHeight: 1.3, tracking: "0.02em" }
  subtitle:{ fontFamily: "Fredoka", weight: 600, cqw: 1.8, lineHeight: 1.2, tracking: "0.02em" }
  quote:   { fontFamily: "Fredoka", weight: 600, cqw: 2.6, lineHeight: 1.35 }
  title:   { fontFamily: "Fredoka", weight: 600, cqw: 3.0, lineHeight: 1.15, tracking: "0.02em" }
  headline:{ fontFamily: "Fredoka", weight: 600, cqw: 4.5, lineHeight: 1.1, tracking: "0.02em" }
  display: { fontFamily: "Fredoka", weight: 600, cqw: 6.5, lineHeight: 1.1, tracking: "0.02em" }
