...
const SHOTS = [
  { n:1, t:'0:00–0:03', img:'phone-home.png',   cap:'Your mind, your genes, your food.',
    action:'App opens; gene grid fades in. (Poster frame.)', vo:'“Meet NeuroNourish.”', trans:'Cut' },
  ...
  { n:6, t:'0:21–0:24', img:'__endcard__',      cap:'NeuroNourish — Understand your mind.',
    action:'Brand end card; icon scales in.', vo:'“NeuroNourish.”', trans:'Fade out' }
];

function cell(s) {
  const thumb = s.img === '__endcard__'
    ? `<div class="thumb endcard"><div class="ec-ic">🧬</div><div class="ec-name">NeuroNourish</div><div class="ec-tag">Understand your mind.</div></div>`
...
const html = `<!DOCTYPE html><html><head><meta charset="utf8"><style>
  *{box-sizing:border-box;margin:0;font-family:"Segoe UI",Helvetica,Arial,sans-serif;}
  ...
  <h1>NeuroNourish — App Preview storyboard</h1>
